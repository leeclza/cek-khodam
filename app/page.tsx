    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-blue-700 p-5 text-center">
      <div className="kartu bg-gray-200 w-full max-w-sm p-5 rounded-lg shadow-lg backdrop-blur-md relative">
        ...
        <input
          ...
          className="w-3/4 mb-5 px-3 py-2 border-2 border-black rounded-lg text-center bg-transparent text-black"
        />

        <button
          onClick={cekGas}
          className="bg-gray-900 text-white px-6 py-2 rounded-full hover:bg-red-500 hover:-translate-y-1 transition-all duration-200 mb-3"
        >
          Cek Khodam
        </button>
        ...
        <button
          onClick={restartLo}
          className="bg-gray-900 text-white px-6 py-2 rounded-full hover:bg-red-500 hover:-translate-y-1 transition-all duration-200"
        >
          Lagi?
        </button>

        {loading && (
          <div className="border-4 border-white border-t-black rounded-full w-10 h-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-spin"></div>
        )}
